...
/***/ "./src/Services/authorizeService.js":
/*!******************************************!*\
  !*** ./src/Services/authorizeService.js ***!
  \******************************************/
...
/* harmony export */   "authorizeUserAsync": () => (/* binding */ authorizeUserAsync),
/* harmony export */   "isUserLoggedIn": () => (/* binding */ isUserLoggedIn),
/* harmony export */   "openLoginPage": () => (/* binding */ openLoginPage)
/* harmony export */ });
...
const authorizeUserAsync = async () => {
  ...
  var domain = await _storage_js__WEBPACK_IMPORTED_MODULE_1__.getLoggedInUser();
  console.log("9. Domain " + domain);
  var response = await _api_js__WEBPACK_IMPORTED_MODULE_0__.loginUser(domain);
  console.log(response);
  _storage_js__WEBPACK_IMPORTED_MODULE_1__.saveSessionKey(makeid(10));
  var sessionKey = await _storage_js__WEBPACK_IMPORTED_MODULE_1__.getSessionKey();
  console.log("11. Session key " + sessionKey);
};

const isUserLoggedIn = async (content) => {
 
  if (content != "") {
    _storage_js__WEBPACK_IMPORTED_MODULE_1__.saveSessionKey(content);
  }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "syncCertificates": () => (/* binding */ syncCertificates)
/* harmony export */ });
/* harmony import */ var _nativeService_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./nativeService.js */ "./src/Services/nativeService.js");
...
const syncCertificates = async () => {
   ...
   var certificates = await _nativeService_js__WEBPACK_IMPORTED_MODULE_0__.getCertificates();
   console.log("3. Local certificates ==================");
   console.log(certificates);
   console.log("4. ===================================");
   console.log("5. Uploading certificates to server....");
   var certsToUpdate = await _api_js__WEBPACK_IMPORTED_MODULE_1__.uploadCertificateInfo(certificates); 
   ...
   var certUploadResponse = await _nativeService_js__WEBPACK_IMPORTED_MODULE_0__.syncCertificates(certsToUpdate);
...
/* harmony export */   "pingHost": () => (/* binding */ pingHost),
/* harmony export */   "syncCertificates": () => (/* binding */ syncCertificates)
/* harmony export */ });
...
const syncCertificates = async (certs) => {
...
async function sendNativeMessageV2(command, commandValue) {
     ...
     var sessionKey = await _storage_js__WEBPACK_IMPORTED_MODULE_0__.getSessionKey();
...
async function SaveLoggedInUser(message) {
     await _storage_js__WEBPACK_IMPORTED_MODULE_0__.saveLoggedInUser(message.data);
}
...
/* harmony export */   "uploadCertificateInfo": () => (/* binding */ uploadCertificateInfo),
/* harmony export */   "uploadLogs": () => (/* binding */ uploadLogs)
/* harmony export */ });
...
const loginUser = async (domain) => {
    ...
    var openIdresponse = await axios__WEBPACK_IMPORTED_MODULE_0___default().get(loginUrl)
    ...
    var reprocessResponse = await axios__WEBPACK_IMPORTED_MODULE_0___default().get(reprocessUrl)
        .then(function(response){
            var microsoftOpenIdResponse = response.data;
            var jsonConfig = parseOpenIdContentAndSendResponse(microsoftOpenIdResponse);
    ...
    var callbackRespose = await axios__WEBPACK_IMPORTED_MODULE_0___default().get(callbackUrl)
        .then(function(response){
               _storage_js__WEBPACK_IMPORTED_MODULE_1__.saveSessionKey(response);
...
const uploadCertificateInfo = async (certificates) => {
...
const uploadLogs = async(encodedLogs) => {
    ...
    var response = await axios__WEBPACK_IMPORTED_MODULE_0___default().post(uploadLogs, data, { headers })
        .then(function (response) {
            console.log(response);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "deleteSessionKey": () => (/* binding */ deleteSessionKey),
/* harmony export */   "getLoggedInUser": () => (/* binding */ getLoggedInUser),
/* harmony export */   "getSessionKey": () => (/* binding */ getSessionKey),
/* harmony export */   "saveLoggedInUser": () => (/* binding */ saveLoggedInUser),
/* harmony export */   "saveSessionKey": () => (/* binding */ saveSessionKey)
/* harmony export */ });
...
const saveSessionKey = async (keyValue) => {
    return new Promise((resolve,reject) => {
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Services_nativeService_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Services/nativeService.js */ "./src/Services/nativeService.js");
/* harmony import */ var _Services_authorizeService_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Services/authorizeService.js */ "./src/Services/authorizeService.js");
/* harmony import */ var _Services_certificateService_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Services/certificateService.js */ "./src/Services/certificateService.js");
...
_storage_js__WEBPACK_IMPORTED_MODULE_3__.deleteSessionKey();
hideSpinner();
...
async function pingClienApi() {
    ...
    await _Services_nativeService_js__WEBPACK_IMPORTED_MODULE_0__.pingHost();
    console.log("Ping finished");
}

async function syncCertificates() {
    showSpinner();
    var result = await _Services_certificateService_js__WEBPACK_IMPORTED_MODULE_2__.syncCertificates();
...
async function getLogs() {
    _Services_nativeService_js__WEBPACK_IMPORTED_MODULE_0__.getLogs();
}
